// import '../sass/speak_it.scss'

const NumberOfMisForCorrectAnwser = 2;
const NumberRightAnwserForNextLevel = 2;
const someHTML = 
`<div class="pagination">
    <div class="level hard_level">
        <p id="0">1</p>
        <p id="1">2</p>
        <p id="2">3</p>
        <p id="3">4</p>
